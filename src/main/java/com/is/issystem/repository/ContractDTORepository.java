...
public interface ContractDTORepository extends JpaRepository<ContractDTO,Integer> {
    @Query(nativeQuery = true,value = "SELECT ct.*,\n" +
            ...
            "       cch.date as date_changed_contract,cch.description,cch.approval_status as approval_status_contract_change,cch.id_attachment as id_attachment_contract_change,cch.id_request,cch.new_information,cch.old_information\n" +
