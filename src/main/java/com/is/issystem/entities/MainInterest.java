...
public class MainInterest {
    ...
    public Integer getPaying_period() {
        return paying_period;
    }

    public void setPaying_period(Integer paying_period) {
        this.paying_period = paying_period;
    }
}
